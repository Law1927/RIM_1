...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    # Validate marker
    $marker = "green-dot.png"; // Default value
    ...
    if (empty($username_err) && empty($email_err) && empty($password_err) && empty($name_err) && empty($latitude_err) && empty($longitude_err) && empty($marker_err)  && empty($ustatus_err)) {
        ...
        $sql = "INSERT INTO locations3 (name, latitude, longitude, color, status) VALUES (?, ?, ?, ?, ?)";
                ...
                <div class="">
                    ...
                    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="marker" id="marker" value="green.png<?= $marker; ?>">
                        ...
                        <p class="mb-0">ADD HOTEL? <a href="./index.php">CLICK</a></p>
<BR>
