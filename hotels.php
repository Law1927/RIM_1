...
<body>
    ...
    <script>
        ...
        if (isset($_POST['employee'])) {
            $sql = " SELECT * FROM locations2 where status='employee' ";
            ...
            $sql = " SELECT * FROM locations2 where status='client' ";
            $result = $conn->query($sql);
            while ($row1 = $result->fetch_assoc()) {
                $name = $row1['name'];
                $latitude = $row1['latitude'];
            ...
            $sql = " SELECT * FROM locations2 where status='car' ";
            $result = $conn->query($sql);
            while ($row1 = $result->fetch_assoc()) {
                $name = $row1['name'];
                $latitude = $row1['latitude'];
            ...
            if (!empty($range_start)) {
                $sql = " SELECT * FROM locations2 where date between '$range_start' and '$range_end' ";
                $result = $conn->query($sql);
                while ($row1 = $result->fetch_assoc()) {
                    $name = $row1['name'];
                    $latitude = $row1['latitude'];
                ...
                $sql = " SELECT * FROM locations2 where name='$search_data' ";
                $result = $conn->query($sql);
                while ($row1 = $result->fetch_assoc()) {
                    $name = $row1['name'];
                    $latitude = $row1['latitude'];
